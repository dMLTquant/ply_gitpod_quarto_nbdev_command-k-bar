...
*Navigation*
<button type="button" onclick="window.location.assign(location.origin)" class="btn btn-outline-primary d-flex">
<div class="me-auto p-2">Home</div >
<div class="p-2">H</div >
</button>
<button type="button" onclick="window.location.assign(location.origin + '/about.html')" class="btn btn-outline-primary d-flex">
